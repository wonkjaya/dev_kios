...
<!-- Navigation -->
    ...
    <!-- End Navigation -->
		<!--div class="row" style="margin-left:auto;margin-right:auto;margin-top:2px;width:40%;min-width:320px;border:0px solid;">
			<div class="col-md-3" 
				style="margin-left:10px;border:1px solid;float:left;height:60px;width:15%;padding:13px;">
			</div>
			<div class="col-md-3" 
				style="margin-left:10px;border:1px solid;float:left;height:60px;width:15%;padding:13px;">
			</div>
